'''
    nohup /local/home/sfoell/anaconda3/envs/gdu_torch/bin/python3.9 -u /local/home/sfoell/GitHub/gdu-pytorch/experiments/wilds/run_expt.py > /local/home/sfoell/GitHub/gdu-pytorch/experiments/wilds/run_expt.log 2>&1 &
'''
...
def main():
    ...
    config = parser.parse_args(['--device', '2',
                                ...
                                '--progress_bar', 'True',
                                '--root_dir', '../wilds/data',
                                '--loss_function', 'gdu_cross_entropy',
                                '--loss_kwargs',
                                'sigma=4',
                                'lambda_OLS=0.001',
                                'lambda_sparse=0.001',
