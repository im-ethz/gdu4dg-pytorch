...
import os
import sys
sys.path.append("/local/home/sfoell/GitHub/gdu-pytorch/experiments/wilds")
...
# See losses.py
losses = ['cross_entropy', 'gdu_cross_entropy', 'lm_cross_entropy', 'MSE', 'multitask_bce', 'fasterrcnn_criterion', 'cross_entropy_logits']
