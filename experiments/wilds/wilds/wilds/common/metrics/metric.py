...
class Metric:
    ...
    def compute(self, y_pred, y_true, algorithm=None, return_dict=True):
        """
    ...
    def compute_group_wise(self, y_pred, y_true, g, n_groups, algorithm=None, return_dict=True):
        """
        ...
        """
        group_metrics, group_counts, worst_group_metric = self._compute_group_wise(y_pred, y_true, g, n_groups, algorithm)
        if return_dict:
            results = {}
