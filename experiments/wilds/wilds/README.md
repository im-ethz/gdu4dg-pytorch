...
```bash
python examples/run_iwildcam.py --dataset iwildcam --algorithm ERM --root_dir data
python examples/run_iwildcam.py --dataset civilcomments --algorithm groupDRO --root_dir data
python examples/run_iwildcam.py --dataset fmow --algorithm DANN --unlabeled_split test_unlabeled --root_dir data
```
